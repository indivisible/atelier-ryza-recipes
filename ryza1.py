...
ADD_ELEMENT_EFFECTS = {
    'ITEM_EFF_CREATE_MATERIAL_BOOST_07': Element.FIRE,
    'ITEM_EFF_CREATE_MATERIAL_BOOST_08': Element.ICE,
    'ITEM_EFF_CREATE_MATERIAL_BOOST_09': Element.THUNDER,
    'ITEM_EFF_CREATE_MATERIAL_BOOST_10': Element.AIR,
}

ELEMENT_RANGE_EFFECTS = {
    'ITEM_EFF_CREATE_MATERIAL_BOOST_14': 1,
    'ITEM_EFF_CREATE_MATERIAL_BOOST_15': 2,
    'ITEM_EFF_CREATE_MATERIAL_BOOST_16': 3,
}
...
def get_item_mat_map():
    tags_path = 'item_mat_tags.txt'
    strings_path = 'saves/text_en/str_item_name.xml'
    return get_tag_map(tags_path, strings_path, 6750209)


def get_item_mix_map():
    tags_path = 'item_tags.txt'
    strings_path = 'saves/text_en/str_item_name.xml'
    return get_tag_map(tags_path, strings_path, 6750446)
...
def main():
    ...
    items = get_item_mat_map()
    items.update(get_item_mix_map())
    parse_items(items)
